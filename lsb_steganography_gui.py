...
class Ui_MainWindow(object):
        ...
        if input_path == '':
            ...
            if output_path == '':
                ...
                try:
                    ...
                    self.displayMsg('Success','Encrypt Successfully!\n\nImage Data Loss = {:.5f} %'.format(loss))
    ...
    def decode(self):
        ...
        if input_path == '':
            ...
            try:
                ...
                self.displayMsg('Success','Decrypt successfully!')
    ...
    def setupUi(self, MainWindow):
        ...
        MainWindow.setWindowIcon(QtGui.QIcon('./pictures/icons-lock.png'))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#2978b5;\">Step 1:</span></p></body></html>"))
        self.label_3.setText(_translate("MainWindow", "Input Image File:"))
        self.pushButton.setText(_translate("MainWindow", "Choose File"))
        self.label.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; color:#2978b5;\">Encrypt</span></p></body></html>"))
        self.label_2.setText(_translate("MainWindow", "<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600; color:#2978b5;\">Decrypt</span></p></body></html>"))
        self.label_5.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#2978b5;\">Step 2:</span></p></body></html>"))
        self.label_7.setText(_translate("MainWindow", "Enter text to hide:"))
        self.label_8.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#2978b5;\">Step 3:</span></p></body></html>"))
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Encrypt and Save"))
        self.label_6.setText(_translate("MainWindow", "<html><head/><body><p><span style=\" font-weight:600; color:#2978b5;\">Step 2:</span></p></body></html>"))
        ...
        self.label_12.setText(_translate("MainWindow", "Decrypted Message:"))
